...
const fundingMessage = numUnfunded === 0 
    ? "All our games are fully funded! Thank you for your support!"
    : `Currently, ${numUnfunded} game${numUnfunded > 1 ? "s" : ""} still need funding. Support them today!`;

// create a new DOM element containing the template string and append it to the description container
const fundingInfo = document.createElement("p");
fundingInfo.innerText = fundingMessage;
